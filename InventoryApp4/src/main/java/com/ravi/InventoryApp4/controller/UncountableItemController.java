...
import com.ravi.InventoryApp4.dao.UncountableItemRepo;
...
public class UncountableItemController {
	...
	{
		ModelAndView mv = new ModelAndView("viewUncountableItem.jsp");
	...
	{
		ModelAndView mv = new ModelAndView("retrieveUncountableItems.jsp");
		UncountableItems uitem = urepo.findById(itemId).orElse(new UncountableItems());
	...
	{
		ModelAndView mv = new ModelAndView("replenishUncountableItem.jsp");
		UncountableItems uitem = urepo.findById(itemId).orElse(new UncountableItems());
	...
	{
		ModelAndView mv = new ModelAndView("uncountableDeleteConfirm.jsp");
		UncountableItems uitem = urepo.findById(itemId).orElse(new UncountableItems());
	...
	public String viewAllUncountableItems(Map<String, Object> map)
	{
		...
		return "viewAllUncountableItems.jsp";
	}
	...
	{
		map.put("itemList", urepo.findAll());
		return "uncountableItemsAdvanced.jsp";
	}
	
	@RequestMapping("/editUncountableItem")
	public ModelAndView editItem(@RequestParam String itemId)
	{
		ModelAndView mv = new ModelAndView("editUncountableItem.jsp");
		UncountableItems uitem = urepo.findById(itemId).orElse(new  UncountableItems());
